...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/webpacker/blob/v5.1.0/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/webpacker/tree/v5.1.0" } if s.respond_to? :metadata=
